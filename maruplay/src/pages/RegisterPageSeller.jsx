...
export default function RegisterSeller() {
  ...
  const [dataRegisterSeller, setDataRegiterSeller] = useState({
    email: "",
    password: "",
    phoneNumber:"",
    address: ""
  ...
  async function registerSeller(data) {
    try {
      ...
      const response = await axios({
        method: "post",
        url: import.meta.env.VITE_BASE_URL + "/seller/register",
        data,
      });
  ...
  function handleRegister(e) {
    ...
    registerSeller(dataRegisterSeller);
  }
  return (
