...
//   console.log(dataToAdd)
  ...
  return (
    <div className="flex items-center h-screen absolute ml-0 mr-0 right-0 left-0  flex-col rounded-lg  cursor-pointer ">
      <div className="bg-blue-400 z-40 w-[50%]">
        <button
          onClick={() => {
            dispatch(setOpenCartModal(false));
          }}
          className="bg-blue-600 w-10 text-white px-4 py-2 rounded-full hover:bg-blue-500"
        >
          X
        </button>
        ...
        <div className="h-[300px] flex flex-col justify-center items-center gap-4 font-semibold text-slate-700">
